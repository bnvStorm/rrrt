<?php include 'head.php';?>
        ...
        <link rel="canonical" href="https://trrr.kz/blog2"/>
        <!-- SEO -->
                    ...
                    <div class="col-lg-8 col-sm-12 col-md-8">
                        <div class="latestBlogItem">
                            ...
                            <div class="lbi_details">
                                ...
                                <h2><a href="blog_single">How to Approach Social Media as a Small Business.</a></h2>
                    ...
                    <div class="col-lg-8 col-sm-12 col-md-8">
                        <div class="latestBlogItem">
                            ...
                            <div class="lbi_details">
                                ...
                                <h2><a href="blog_single">Multiple customers in various industries and segments</a></h2>
                                <a class="learnM" href="blog_single">Learn More</a>
                            </div>
                        </div>
                    </div>

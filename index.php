<?php include 'head.php';?>
        <!-- SEO -->
        <title>RRR Technology - официальный сайт</title>
    ...
    <body>
        ...
        <section class="commonSection ab_agency" id="ab_agency">
            <div class="container">
                <div class="row">
...
Сбор, транспортировка, переработка и отгрузка вторичного сырья потребителям выполняются силами сотрудников компании.
Все вопросы и проблемы с вывозом сырья из магазинов, пунктов по сбору, организаций и с предприятий любой формы собственности решаются одним телефонным звонком!
В настоящее время наша компания активно продвигает свои услуги на рынок переработки сырья и предлагает своим деловым партнерам очень выгодные условия при заключении контракта.
                    ...
                    <div class="col-lg-6 col-sm-6 col-md-6">
                        <div class="ab_img1">
                            <img class="lazyload" data-src="images/home_1/abmain.jpg" alt=""/>
                        </div>
                        <div class="ab_img2">
                            <img class="lazyload" data-src="images/home_1/abmain.jpg" alt=""/>
                        </div>
...
<!--       <section class="commonSection what_wedo">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h4 class="sub_title">тут должен быть </h4>
                        <h2 class="sec_title">ваш текст</h2>
                        <p class="sec_desc">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-7 col-md-7">
                                        <div class="abci_content">
                                            ...
                                            <p>
                                                Люди любят цифры.Точно говорю.Да.
                                            </p>
                                            <a class="common_btn red_bg" href="#"><span>Ссылка</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-4 col-md-3 text-right">
                        <a class="common_btn" href="#"><span>Ссылка</span></a>
                    </div>
                </div>
            </div>
        </section> -->

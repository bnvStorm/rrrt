<?php include '../../head.php';?>
        ...
        <link rel="canonical" href="https://trrr.kz/pages/showcase/maslo2"/>
        <!-- SEO -->
    </head>
    <body>
        <!-- Preloading -->
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 col-md-6">
                        <div class="portDetailThumb">
                            <img class="lazyload" data-src="https://trrr.kz/images/portfolio/7.jpg" alt=""/>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-md-6">

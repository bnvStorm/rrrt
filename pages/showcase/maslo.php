<?php include '../../head.php';?>
         <!-- SEO -->
        <title>Утилизация фритюрного масла | RRR Technology</title>
        <meta name="description" content="Лидер на рынке вторичного сырья в Казахстане.">
        <meta name="robots" content="index,follow">
        <link rel="canonical" href="https://trrr.kz/pages/showcase/maslo"/>
        <!-- SEO -->
    </head>
    <body>
        <!-- Preloading -->
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 col-md-6">
                        <div class="portDetailThumb">
                            <img class="lazyload" data-src="https://trrr.kz/images/portfolio/2.jpg" alt=""/>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-md-6">
